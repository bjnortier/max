...
class MetalheadEnvV5(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
    ...
    def _step(self, action):
        ...
        reward_torso_pitch = -0.2 * np.square(torso_pitch_angle_after)
        reward_torso_roll = -0.2 * np.square(torso_roll_angle_after)
